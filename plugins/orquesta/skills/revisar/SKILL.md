...
- Si el argumento es `BRIEF-NN`, el brief está en `.orquesta/briefs/BRIEF-NN.md` y el reporte, si existe, en `.orquesta/reportes/REPORTE-NN.md` (o `REPORTE-NN-codex.md` si el trabajador corrió en Codex).
